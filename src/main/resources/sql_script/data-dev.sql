...
INSERT INTO tb_products (id, category, price, description, imageurl, name) VALUES
    ...
    ('e6bf8692-c8b0-40d8-8c5c-1ff54944d20d', 4, 5.00, 'Torta de maçã com canela', 'http://example.com/images/torta_maca.jpg', 'Torta de Maçã') ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_clients (id, name, cpf, email) VALUES
    ...
    ('f7a0491d-cfb0-4891-9d50-f0a2f95eb788', 'Vinicius Martin Tiago da Rocha', '136.992.179-90', 'vinicius_darocha@easytechconsultoria.com.br') ON CONFLICT (id) DO NOTHING;